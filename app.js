...
function modal_088() {
    Swal.fire({
        ...
        //CARPETA 1 
        '<a href="https://drive.google.com/drive/folders/1AkyVmqyM79xpI5mu11uuFK0BhJfIv4pA?usp=share_link" target="_blank">' +
...
function modal_08() {
    Swal.fire({
        html: '<div class="mensaje-2">' +
            ...
            //mediafire jpg
            '<a href="https://drive.google.com/drive/folders/1meTGgYEaVkYlefp6e0MKBp0BLR6KbATz?usp=sharing" target="_blank">'+
...
const enviarFormulario = () => {
    ...
    var win = window.open(`https://wa.me/54${numero}?text=Mis Fotos Ana  App Web:%20https://bit.ly/3jExma0%0APara que el enlace se active me tienes que ajenar`, '_blank');
...
botonWspp.addEventListener('click', function () {
    location.href = "https://wa.me/?text=https://bit.ly/3jExma0"
});
...
shareBtn.addEventListener('click', event => {
    if (navigator.share) {
        //drive
        navigator.share({
            text: 'Instala la App web "Mis Fotos Ana ": ',
            url: 'https://bit.ly/3jExma0'
        }).then(() => {
            console.log('Gracias por compartir Mis Fotos Ana !');
        })
